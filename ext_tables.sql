...
CREATE TABLE tx_rkwcheckup_domain_model_chapter (
	...
	interim_result int(11) unsigned DEFAULT '0',
...
CREATE TABLE tx_rkwcheckup_domain_model_answer (
	...
	title varchar(255) DEFAULT '' NOT NULL,
	description text,
	figure int(11) unsigned NOT NULL default '0',
...
#
# Table structure for table 'tx_rkwcheckup_domain_model_interimresult'
#
CREATE TABLE tx_rkwcheckup_domain_model_interimresult (
